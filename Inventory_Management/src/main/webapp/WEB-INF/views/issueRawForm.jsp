...
<body>
 ...
 <div class="home-content">
  <form action="issueRawMaterial" method="post" >
    <center><h1>Issue Raw Material</h1></center>
    <br>
    ...
    <label for="quantity">Issuer Name</label>
    <input type="text" name="issuer_name" placeholder="Enter Issuer Name..">
    
    <label for="quantity">Material Id</label>
    <input type="text" name="itemId" placeholder="Enter Material Id..">
     <br><br>
    <label for="cpu">Date</label>
