...
<%@ page import="model.*" %>
 ...
 <br>
  ...
  <% 
     ...
     for(ProcessedItem rm : processedItem )
     {	 
  %>
  <tr>
    <td><%= rm.getId() %></td>
    ...
    <td><%=rm.getUnit() %></td>
    <td><%= rm.getCpu() %></td>
    <td><a href="updateprocessedquan?id=<%= rm.getId() %>">Update</a></td>
    <td><a href="deleteprocessed/<%= rm.getId() %>">Delete</a></td>
  </tr>
  <% } %>
  </tbody>
  </table> 
