...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="viewProcessed" class="active">
            <i class='bx bx-book-alt' ></i>
 ...
 <div class="home-content">
  <form action="updateProcessedQuan" method="post" >
    <center><h1>Add New Quantity</h1></center>
    <br>
    <label for="id">New Quantity</label>
    <input type="text"  name="quan" placeholder="Enter Quantity ..">
